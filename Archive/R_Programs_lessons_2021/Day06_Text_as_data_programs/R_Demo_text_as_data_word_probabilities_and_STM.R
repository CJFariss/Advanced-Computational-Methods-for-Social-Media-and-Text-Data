...
##
## We can therefore see with certainy the probability that a document is of even or odd type (i.e., the topic) because it is the proportion of those words of a specific type that it contains.
##
...
## inspect the topic proportsion which is theta
head(fit$theta, 10)
