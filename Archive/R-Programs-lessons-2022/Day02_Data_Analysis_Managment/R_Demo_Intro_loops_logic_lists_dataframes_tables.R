...
## so far we have looked at simple statements. we can make these compound statments using the AND operator & (also &&), the OR operator | (also ||) (there are more but let's not worry about these additional operators now)
